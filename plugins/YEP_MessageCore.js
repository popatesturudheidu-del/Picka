...
Game_System.prototype.isFastFowardEnabled = function () {
    if (this._fastForward === undefined) {
        this.initMessageSystem();
    }
...
Game_System.prototype.getMessageFontName = function () {
    if (this._msgFontName === undefined) {
        this.initMessageFontSettings();
    }
...
Game_System.prototype.getMessageFontSize = function () {
    if (this._msgFontSize === undefined) {
        this.initMessageFontSettings();
    }
...
Game_System.prototype.getMessageFontOutline = function () {
    if (this._msgFontOutline === undefined) {
        this.initMessageFontSettings();
    }
...
Game_Interpreter.prototype.pluginCommand = function (command, args) {
    ...
    if (command === 'EnableWordWrap') {
        $gameSystem.setWordWrap(true);
    }
    if (command === 'DisableWordWrap') {
        $gameSystem.setWordWrap(false);
    }
    if (command === 'EnableFastForward') {
        $gameSystem.setFastFoward(true);
    }
    if (command === 'DisableFastForward') {
        $gameSystem.setFastFoward(false);
    }
};
...
Game_Interpreter.prototype.command101 = function () {
    if (!$gameMessage.isBusy()) {
        ...
        while (this.isContinueMessageString()) {
            ...
            if ($gameMessage._texts.length >= $gameSystem.messageRows()) {
                break;
            }
        }
...
Window_NameBox.prototype.update = function () {
    ...
    this._closeCounter -= 60 * SceneManager._deltaTime;
    if (this._closeCounter > 0) {
        return;
    }
...
Window_Message.prototype.isFastForward = function () {
    if (!$gameSystem.isFastFowardEnabled()) {
        return false;
    }
...
Window_Message.prototype.updateInput = function () {
    if (this.pause && this.isFastForward()) {
        if (!this._textState) {
            this.pause = false;
            this._waitCount = Math.max(1, this._waitCount);
...
Window_Message.prototype.updateWait = function () {
    if (this.isFastForward()) {
        this._waitCount = Math.min(1, this._waitCount);
        return false;
    }
...
Yanfly.Message.Window_Message_drawLanguageIcon = Window_Message.prototype.drawLanguageIcon;
Window_Base.prototype.drawLanguageIcon = function (...args) {
    if (this._checkWordWrapMode) {
        return;
    }
    Yanfly.Message.Window_Message_drawLanguageIcon.apply(this, args)
}

Yanfly.Message.Window_Message_drawSvActor = Window_Message.prototype.drawSvActor;
Window_Base.prototype.drawSvActor = function (...args) {
    if (this._checkWordWrapMode) {
        return;
    }
    Yanfly.Message.Window_Message_drawSvActor.apply(this, args)
}

Yanfly.Message.Window_Message_drawIconCustom = Window_Message.prototype.drawIconCustom;
Window_Base.prototype.drawIconCustom = function (...args) {
    if (this._checkWordWrapMode) {
        return;
    }
    Yanfly.Message.Window_Message_drawIconCustom.apply(this, args)
}

Yanfly.Message.Window_Message_drawFace = Window_Message.prototype.drawFace;
Window_Base.prototype.drawFace = function (...args) {
    if (this._checkWordWrapMode) {
        return;
    }
    Yanfly.Message.Window_Message_drawFace.apply(this, args)
}

Yanfly.Message.Window_Message_drawCharacter = Window_Message.prototype.drawCharacter;
Window_Base.prototype.drawCharacter = function (...args) {
    if (this._checkWordWrapMode) {
        return;
    }
    Yanfly.Message.Window_Message_drawCharacter.apply(this, args)
}

Yanfly.Message.Window_Message_drawIcon = Window_Message.prototype.drawIcon;
Window_Message.prototype.drawIcon = function (...args) {
    if (this._checkWordWrapMode) {
        return;
    }
    Yanfly.Message.Window_Message_drawIcon.apply(this, args)
}

Yanfly.Message.Window_Message_drawIconGray = Window_Message.prototype.drawIconGray;
Window_Message.prototype.drawIconGray = function (...args) {
    if (this._checkWordWrapMode) {
        return;
    }
    Yanfly.Message.Window_Message_drawIconGray.apply(this, args)
}
