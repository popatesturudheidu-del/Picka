...
Window_EventMiniLabel.prototype.getProperties = function () {
...
Window_EventMiniLabel.prototype.refresh = function() {
    ...
    this.clear();
    const textSprite = this.parseText(this._text);
    textSprite.pivot.x = Math.floor(textSprite.logicalWidth / 2);
    textSprite.position.set(Math.floor(this.contents.width / 2), 0);
...
Window_EventMiniLabel.prototype.show = function() {
    ...
    this.contentsOpacity += 16 * 60 * SceneManager._deltaTime;
    this.visible = true;
};
