...
Remtairy.EditedForeground = Remtairy.EditedForeground || {};

var Imported = Imported || {};
Imported.RemEditedForeground = true;
...
Game_Map.prototype.foregroundNotSwitchB = function() {
    return this._foregroundNotSwitchB;
};
Game_Map.prototype.foregroundNotSwitchB2 = function() {
    return this._foregroundNotSwitchB2;
};
  ...
  Remtairy.EditedForeground.Game_Map_setup = Game_Map.prototype.setup;
  Game_Map.prototype.setup = function(mapId) {
    //_Game_Map_setup.call(this, mapId);
	Remtairy.EditedForeground.Game_Map_setup.call(this, mapId);
  ...
  Game_Map.prototype.setupForeground = function() {
	...
	this._foregroundSwitch = $dataMap.meta.fgSwitch || 0;
	...
	this._foregroundNotSwitchB = $dataMap.meta.fgNotSwitch_b || 0;
	this._foregroundNotSwitchB2 = $dataMap.meta.fgNotSwitch_b2 || 0;
  ...
  Game_Map.prototype.updateForeground = function() {
    ...
    if (this._foregroundLoopX) {
      this._foregroundX += this._foregroundSx * delta / this.tileWidth() / 2;
    }
    if (this._foregroundLoopY) {
      this._foregroundY += this._foregroundSy * delta / this.tileHeight() / 2;
    }
  };
  ...
  Spriteset_Map.prototype.updateForeground = function() {
	...
	let foregroundNotSwitchBNotTriggered = true;
	if($gameMap.foregroundNotSwitchB() !== 0) {
		if($gameSwitches.value($gameMap.foregroundNotSwitchB())) foregroundNotSwitchBNotTriggered = false;
	}
	if($gameMap.foregroundNotSwitchB2() !== 0) {
		if($gameSwitches.value($gameMap.foregroundNotSwitchB2())) foregroundNotSwitchBNotTriggered = false;
	}
	...
	else if($gameSwitches.value($gameMap.foregroundSwitchB()) && foregroundNotSwitchBNotTriggered) {
