...
(function () {
    ...
    MPPlugin.ScrollBarColor1 = `rgb(${parameters['Scroll Bar Color1'] || '128,128,128'})`;
    MPPlugin.ScrollBarColor2 = `rgb(${parameters['Scroll Bar Color2'] || '192,192,192'})`;
...
Window_Selectable.prototype._refreshScrollBar = function () {
    ...
    if (maxRow > maxPageRows) {
        if (!this._scrollBarSprite) {
            ...
            this._scrollBarSprite.name = 'Scroll Bar';
...
Window_Selectable.prototype._updateScrollBar = function () {
    if (this._scrollBarSprite) {
        ...
        if (this._scrollBarCount > 0) {
            this._scrollBarCount -= delta;
        }
        if (this.isScrollBarActive()) {
            this._scrollBarSprite.opacity += 32 * delta;
        } else {
            this._scrollBarSprite.opacity -= 4 * delta;
        }

		//REM
		if(this._logMainSprite && this._logMainSprite.visible) {
