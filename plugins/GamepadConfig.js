...
Input.getPressedGamepadButton = function() {
	if (Yanfly.Param.GamepadTimer > 0) {
		Yanfly.Param.GamepadTimer -= 60 * SceneManager._deltaTime;
		return -1;
	}
...
Yanfly.GamepadConfig.Window_Options_drawItem = Window_Options.prototype.drawItem;
...
Window_GamepadConfig.prototype.getButtonTypeText = function(index) {
	if (index === 0) return TextManager.yanflyOptionsOkButtonName;
	if (index === 1) return TextManager.yanflyOptionsCancelButtonName;
	if (index === 2) return TextManager.yanflyOptionsShiftButtonName;
	if (index === 3) return TextManager.yanflyOptionsMenuButtonName;
	if (index === 4) return TextManager.yanflyOptionsPageUpButtonName;
	if (index === 5) return TextManager.yanflyOptionsPageDownButtonName;
	if (index === 7) return TextManager.yanflyOptionsResetDefaultName;
	if (index === 8) return TextManager.yanflyOptionsFinishConfigName;
	return '';
};
...
Window_GamepadConfig.prototype.getButtonConfig = function(index) {
  ...
  return TextManager.yanflyOptionsGamepadButtonName.format(button);
};
...
Window_GamepadConfig.prototype.updateHelp = function() {
    if (!this._helpWindow) return;
		switch (this.index()) {
		case 0:
			this._helpWindow.setText(TextManager.yanflyOptionsOkButtonHelp);
			break;
		case 1:
			this._helpWindow.setText(TextManager.yanflyOptionsCancelButtonHelp);
			break;
		case 2:
			this._helpWindow.setText(TextManager.yanflyOptionsShiftButtonHelp);
			break;
		case 3:
			this._helpWindow.setText(TextManager.yanflyOptionsMenuButtonHelp);
			break;
		case 4:
			this._helpWindow.setText(TextManager.yanflyOptionsPageUpButtonHelp);
			break;
		case 5:
			this._helpWindow.setText(TextManager.yanflyOptionsPageDownButtonHelp);
			break;
		case 7:
			this._helpWindow.setText(TextManager.yanflyOptionsResetDefaultHelp);
			break;
		case 8:
			this._helpWindow.setText(TextManager.yanflyOptionsFinishConfigHelp);
			break;
		default:
...
Scene_GamepadConfig.prototype.updateAfterConfig = function() {
	...
	this._configTimer -= 60 * SceneManager._deltaTime;
