...
(function () {
  ...
  @media screen and (min-width : 768px) and (max-width : 1000px) {
	...
	field.innerHTML = divRemInnerHTML;
  ...
  TextBox.onLoadAfterInnerHTML = function () {
    if(SceneManager._scene) {
	  ...
	  if( (SceneManager._scene instanceof Scene_Options)) {
          if(SceneManager._scene._optionsWindow._textBox) {
            SceneManager._scene._optionsWindow._textBox.addAllEventListener();
          }
      }
    }
  };
  ...
  TextBox.prototype.addAllEventListener = function () {
	...
	if(ConfigManager.lovenseInputingPort)
		this._textBox.maxLength = 5;
	else
		this._textBox.maxLength = 25;
	...
	//this._textBox.addEventListener('mousedown', this.onMouseDown.bind(this));
  ...
  TextBox.prototype.setTextHint = function () {
	...
	return textBox.placeholder = TextManager.yanflyOptionsLovenseMobileHint;
  };
