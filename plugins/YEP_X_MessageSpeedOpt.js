...
Window_Message.prototype.messageSpeed = function() {
  return 10.9 - (ConfigManager.messageSpeed.clamp(0, 11));
};
...
Window_Message.prototype.updateMessage = function() {
  ...
  while (!this.isEndOfText(this._textState)) {
    ...
    const isShowFast = this._showFast || this._lineShowFast || $gameMessage._forcedShowFast;

    if (this._textDelay > 0) {
      this._textDelay = isShowFast ? 0 : this._textDelay - 60 * SceneManager._deltaTime;
    }
...
if (Imported.YEP_X_ExtMesPack1) {
  Yanfly.EMP1.Window_Message_updateMessage = Window_Message.prototype.updateMessage;
  Window_Message.prototype.updateMessage = function () {
    var state = Yanfly.EMP1.Window_Message_updateMessage.call(this);
    if (state) {
      this._soundCount = this._soundCount || 0;
      this._soundCount -= 60 * SceneManager._deltaTime;
...
Window_Options.prototype.statusText = function(index) {
  ...
  if (symbol === 'messageSpeed') {
    if (value > 10) return TextManager.yanflyOptionsMessageSpeedNoWait;
