...
Yanfly.Equip.Window_EquipSlot_updateHelp = Window_EquipSlot.prototype.updateHelp;
Window_EquipSlot.prototype.updateHelp = function() {
    Yanfly.Equip.Window_EquipSlot_updateHelp.call(this);
...
Yanfly.Equip.Window_EquipItem_updateHelp = Window_EquipItem.prototype.updateHelp;
Window_EquipItem.prototype.updateHelp = function() {
    Yanfly.Equip.Window_EquipItem_updateHelp.call(this);
    if (SceneManager._scene instanceof Scene_Equip && this._infoWindow) {
      this._infoWindow.setItem(this.item());
    }
};
...
Window_StatCompare.prototype.refresh = function() {
    ...
    if (!this._actor) return;
    for (var i = 0; i < 8; ++i) {
        this.drawItemWithContext(0, this.lineHeight() * i, i);
    }
};
