...
Game_Actor.prototype.isInstantCast = function(item) {
	...
	*/
	...
	let defaultIsInstantCast = item.instantCast;
	if(defaultIsInstantCast) return true;
	
	if(this._hasDescendedSilentFreeActionFlag) {
		this._hasDescendedSilentFreeActionFlag = false;
		return true;
	}
